...
terminallauncher = awful.widget.launcher({
                                            image = image("/usr/share/icons/Humanity/apps/48/utilities-terminal.svg"),
                                            command = "env VTK_CJK_WIDTH=1 gnome-terminal --hide-menubar --disable-factory"
                                      })
emacslauncher = awful.widget.launcher({ image = image("/usr/local/share/icons/hicolor/48x48/apps/emacs.png"),
                                           command = "emacs --reverse"})
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ modkey}, "z", function () scratch.drop(terminal, "top") end),
